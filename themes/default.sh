...
MENU_PROMPT_COLORS=("PINK" "CYAN")

MENU_BADGE_LEFT="${BG_COLORS[GREEN]}${COLORS[BLACK]}"
MENU_BADGE_RIGHT="${BG_COLORS[NOCOLOR]}${COLORS[GREEN]}"

MENU_BADGE_SEARCH_LEFT="${BG_COLORS[NOCOLOR]}${COLORS[BLUE]}"
MENU_BADGE_SEARCH_RIGHT="${BG_COLORS[BLUE]}${COLORS[BLACK]}"
...
MENU_HEADER_RIGHT=()
MENU_HEADER_RIGHT+=("${BG_COLORS[NOCOLOR]}${COLORS[GREEN]}")
MENU_HEADER_RIGHT+=("${BG_COLORS[NOCOLOR]}${COLORS[BLUE]}")
MENU_HEADER_RIGHT+=("${BG_COLORS[NOCOLOR]}${COLORS[PINK]}")
MENU_HEADER_RIGHT+=("${BG_COLORS[NOCOLOR]}${COLORS[YELLOW]}")

MENU_COLUMN_LEFT=()
MENU_COLUMN_LEFT+=("${BG_COLORS[NOCOLOR]}${COLORS[GREEN]}")
MENU_COLUMN_LEFT+=("${BG_COLORS[NOCOLOR]}${COLORS[BLUE]}")
MENU_COLUMN_LEFT+=("${BG_COLORS[NOCOLOR]}${COLORS[PINK]}")
MENU_COLUMN_LEFT+=("${BG_COLORS[NOCOLOR]}${COLORS[YELLOW]}")

MENU_COLUMN_RIGHT=()
MENU_COLUMN_RIGHT+=("${BG_COLORS[GREEN]}${COLORS[BLACK]}")
MENU_COLUMN_RIGHT+=("${BG_COLORS[BLUE]}${COLORS[BLACK]}")
MENU_COLUMN_RIGHT+=("${BG_COLORS[PINK]}${COLORS[BLACK]}")
MENU_COLUMN_RIGHT+=("${BG_COLORS[YELLOW]}${COLORS[BLACK]}")
...
# Category
PACKAGES_HEADER_RIGHT+=("${BG_COLORS[NOCOLOR]}${COLORS[GREEN]}")
# Name
PACKAGES_HEADER_RIGHT+=("${BG_COLORS[NOCOLOR]}${COLORS[YELLOW]}")
# Source
PACKAGES_HEADER_RIGHT+=("${BG_COLORS[NOCOLOR]}${COLORS[PINK]}")
# Installed
PACKAGES_HEADER_RIGHT+=("${BG_COLORS[NOCOLOR]}${COLORS[GREEN]}")
# Candidate
PACKAGES_HEADER_RIGHT+=("${BG_COLORS[NOCOLOR]}${COLORS[CYAN]}")
# Maintainer
PACKAGES_HEADER_RIGHT+=("${BG_COLORS[NOCOLOR]}${COLORS[BLUE]}")
# Description
PACKAGES_HEADER_RIGHT+=("${BG_COLORS[NOCOLOR]}${COLORS[WHITE]}")

PACKAGES_COLUMN=()
# Category
PACKAGES_COLUMN+=("${BG_COLORS[GREEN]}${COLORS[BLACK]}")
# Name
PACKAGES_COLUMN+=("${BG_COLORS[YELLOW]}${COLORS[BLACK]}")
# Source
PACKAGES_COLUMN+=("${BG_COLORS[PINK]}${COLORS[BLACK]}")
# Installed
PACKAGES_COLUMN+=("${BG_COLORS[GREEN]}${COLORS[BLACK]}")
# Candidate
PACKAGES_COLUMN+=("${BG_COLORS[CYAN]}${COLORS[BLACK]}")
# Maintainer
PACKAGES_COLUMN+=("${BG_COLORS[BLUE]}${COLORS[BLACK]}")
# Description
PACKAGES_COLUMN+=("${BG_COLORS[WHITE]}${COLORS[BLACK]}")
